<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profiles.aspx.cs" Inherits="International_Jobs_Portal.profiles.profiles" %>
...
<body>
    ...
    <!------------------------ PROFILES ------------------------------>
    <div id="profiles" class="">
        <div class="container">
            <div class="procont">
                <h1 class="profilesheading"><a href="profiles.aspx">Profiles</a></h1>
               <div>
                    <h1><a href="profiles.aspx">Search</a></h1>
                    <label for="experience"><b>Experience</b></label>
                <br />
                <asp:DropDownList ID="experience" CssClass="dropdown1"  runat="server">
                    ...
                    <asp:ListItem Value="+6 Year">+6 Years</asp:ListItem>

                </asp:DropDownList>
                </div>
                <div>
                    <label for="profession"><b>By City</b></label><br />
                <input id="city" type="text" placeholder="Type Here..." class="t" runat="server"/>
                </div>
                <div>
                    <label for="profession"><b>Functional Area</b></label>
                <br />
                <asp:DropDownList ID="functionalArea" CssClass="dropdown1"  runat="server">
                    <asp:ListItem Selected="False" Value="">Select Here...</asp:ListItem>
                ...
                <div>
                    <label for="profession"><b>Expected Sallery</b></label><br />
                <asp:DropDownList ID="expectedSallery" CssClass="dropdown1"  runat="server">
                    <asp:ListItem Selected="False" Value="">Select Here...</asp:ListItem>
                ...
                <asp:ListView ID="ListView1" runat="server">
                    <ItemTemplate>
                        <div>
                            <table>
                                    <div class='tile'>
                                        <%--<asp:Image CssClass='tile-img' ID="Image2" ImageUrl='<%#"data:Image/png;base64," + Convert.ToBase64String((byte[])Eval("userPic")) %>'  runat="server" />--%>
                                        <div class='tile-info'>
        ...
        <asp:GridView ID="gvDocuments" runat="server" AutoGenerateColumns="False" DataKeyNames="ID">
            <Columns>
                <asp:TemplateField HeaderText="Documents">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" OnClick="OpenDocument" runat="server" Text='<%# Eval("Names") %>'></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>--%>
